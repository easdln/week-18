...
function makeTwo() {
	localStorage.setItem('num','7,6,5')
...
function makeSix() {
	...
	localStorage.setItem('objectSix', jsonString)
...
function makeSeven() {
	...
	const jsonString = JSON.stringify(obj);
	localStorage.setItem('objectSeven', jsonString)
	console.log('Объект obj был записан в Local Storage.');
}
...
function makeEight() {
	...
	const jsonString = JSON.stringify(obj);
	localStorage.setItem('objectEight', jsonString)
	console.log('Объект obj был записан в Local Storage.');
}
...
function makeNine() {
	...
	localStorage.setItem('arrayNine',jsonString)
...
function makeTen() {
	...
	const jsonString = JSON.stringify(arr);
	localStorage.setItem('arrayTen',jsonString);
	console.log('Массив arr был записан в Local Storage.');
}
...
function makeEleven() {
	...
	const jsonString = JSON.stringify(arr);
	localStorage.setItem('arrayEleven', jsonString)
	console.log('Массив arr был записан в Local Storage.');
}
...
function showEleven() {
	const getArray = localStorage.getItem('arrayEleven');
	const arrayEleven = JSON.parse(getArray);
	let output = '';
